...
describe('setupCarousel', () => {
  it('initializes with the first slide active', () => {
    setupCarousel();
    expect(document.querySelectorAll('.slide')[0].classList.contains('active')).toBe(true);
    expect(document.querySelectorAll('.slide')[0].classList.contains('hidden')).toBe(false);
  });
